module.exports = (app) => {
    ...
    const upload_product_img = require("../middlewares/uploadProductImage");
    var router = require("express").Router();
    app.use("/api/product", router);

    router.post("/create_product/", upload_product_img.fields([{ name: "image", maxCount: 1 }]), productController.product_create);
